...
namespace WebApplication1.Services
{
    public class MatchingService
    {
        ...
        // R�gles : distance calcul�e, pas de r�trogradation (niveau offre >= niveau actuel), max +5 niveaux
            ...
            List<Postes> postesReference)
        {
            ...
            foreach (var offre in offres)
            {
                ...
                // R�gles m�tier
                if (offerRank < currentRank) continue;          // pas de r�trogradation
        ...
        // Mapping simple de niveaux hi�rarchiques en rangs entiers
        private int GetHierarchyRank(string niveau)
        {
            ...
            return 2; // valeur neutre par d�faut
        }
    }
}